// Package app for initiate configurations. Configuration saved in TOML files inside
// config folder, important information like database connection and JWT keys 
...
// The configuration file(s) should be named as app.toml.
...
func LoadConfig(configPaths ...string) error {
	...
	v.AutomaticEnv()
	v.SetDefault("error_file", "config/errors.toml")
